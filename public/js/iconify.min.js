...
var Iconify = (function () {
  ...
  var n = e(function (e, n) {
        ...
        if (
          (Object.keys(u).forEach(function (e) {
            ...
            'string' == typeof r.body &&
              (t(e, Object.freeze(Object.assign({}, n.iconDefaults, c, r))), a.push(e));
          }),
    ...
    a = e(function (e, n) {
      ...
      function u(e, n) {
        ...
        if (
          ('string' != typeof n && (n = 'string' == typeof e.provider ? e.provider : ''),
          ...
          [e, n].forEach(function (e) {
            ...
            switch (
              (r
                ? o
                  ? (c += 2)
                  : (t.push('translate(' + (i.width + i.left) + ' ' + (0 - i.top) + ')'),
                    t.push('scale(-1 1)'),
                    (i.top = i.left = 0))
                : o &&
                  (t.push('translate(' + (0 - i.left) + ' ' + (i.height + i.top) + ')'),
                  t.push('scale(1 -1)'),
                  (i.top = i.left = 0)),
              ...
              case 2:
                t.unshift(
                  'rotate(180 ' + (i.width / 2 + i.left) + ' ' + (i.height / 2 + i.top) + ')',
                );
                break;
              case 3:
            ...
            c % 2 == 1 &&
              ((0 === i.left && 0 === i.top) || ((n = i.left), (i.left = i.top), (i.top = n)),
              i.width !== i.height && ((n = i.width), (i.width = i.height), (i.height = n))),
    ...
    v = e(function (e, n) {
      Object.defineProperty(n, '__esModule', { value: !0 }),
        (n.storeCache = n.loadCache = n.mock = n.emptyList = n.count = n.config = void 0);
      var t = 'iconify2',
        r = 'iconify',
        o = 'iconify-count',
        a = 'iconify-version',
                ...
                var a = {
                  ...
                  resource: r,
                    ...
                    !(function (n, t, r) {
                      ...
                      if (a)
                        return void 0 !== r && (v = r), void (h.length || (i.length ? O() : j()));
                      if ((m(), x(), o && !e.random)) {
          ...
          return (
            e.forEach(function (e) {
              ...
              (n && !o.validateIcon(i, t)) ||
                r.push({ provider: i.provider, prefix: i.prefix, name: i.name });
            }),
            r
          );
        }),
      ...
      function v(e, n, t) {
        function a() {
          ...
          s[t] < r &&
            ((s[t] = r),
            console.error(
              'Unable to retrieve icons for "' + t + '" because API is not configured properly.',
            ));
        }
        void 0 === o[e] && (o[e] = Object.create(null));
        var f = o[e];
          ...
          prepare: function (n, t, c) {
                ...
                if (u.maxURL) {
                  ...
                  u.resources.forEach(function (e) {
                    ...
                    (c =
                      ...
                      f -
                      u.path.length -
                      r.replace('{provider}', n).replace('{prefix}', t).replace('{icons}', '')
                        .length -
                      3);
                } else c = 0;
                var l = n + ':' + t;
            ...
            return (
              c.forEach(function (e, r) {
                (s += e.length + 1) >= f &&
                  r > 0 &&
                  (u.push(l), (l = { provider: n, prefix: t, icons: [] }), (s = e.length)),
                  l.icons.push(e);
              }),
              u.push(l),
              u
        ...
        return {
          prepare: function (n, i, a) {
                ...
                if (c.maxURL) {
                  ...
                  c.resources.forEach(function (e) {
                    ...
                    (a =
                      ...
                      u -
                      c.path.length -
                      t.replace('{provider}', n).replace('{prefix}', i).replace('{icons}', '')
                        .length);
                } else a = 0;
                var f = n + ':' + i;
            ...
            return (
              a.forEach(function (e, t) {
                (l += e.length + 1) >= u &&
                  t > 0 &&
                  (c.push(f), (f = { provider: n, prefix: i, icons: [] }), (l = e.length)),
                  f.icons.push(e);
              }),
              c.push(f),
              c
          ...
          send: function (e, n, r) {
            var a = n.provider,
              ...
              f =
                o[a + ':' + c] +
                t.replace('{provider}', a).replace('{prefix}', c).replace('{icons}', u);
            i
              ? i(e + f)
                  .then(function (e) {
      ...
      n
        ...
        : (function (e) {
            ...
            ('loading' !== n.readyState && !n.documentElement.doScroll)
              ? e()
              : (n.addEventListener('DOMContentLoaded', e), window.addEventListener('load', e));
          })(q);
  }
  function G(e) {
  ...
  function J(e) {
    return (
      'string' == typeof e && (e = o.stringToIcon(e)), null !== e && o.validateIcon(e) ? e : null
    );
  }
  function Y(e) {
    var n = [];
        ...
        if (r && r.querySelectorAll) {
          ...
          Y(r).forEach(function (n) {
            ...
            if (
              ...
              ((r = p.name),
              (c = f),
              null !== r && null !== c && r.name === c.name && r.prefix === c.prefix)
            )
              switch (p.status) {
                case 'missing':
                  return;
                case 'loading':
                  if (
                    d.coreModules.api &&
                    d.coreModules.api.isPending({ provider: l, prefix: s, name: v })
                  )
                    return void (o = !0);
              }
            ...
            if (void 0 === h.icons[v]) {
              if (h.missing[v])
                return (p = { name: f, status: 'missing', customisations: {} }), void (u[S] = p);
              if (
                d.coreModules.api &&
                !d.coreModules.api.isPending({ provider: l, prefix: s, name: v })
              ) {
  ...
  var re = ['inline', 'hFlip', 'vFlip'],
    ...
    ae = {
      ...
      customisations: function (e, n) {
        ...
        if (
          (-1 !== (r ? r.split(/\s+/) : []).indexOf(ie) && (t.inline = !0), ne(e, 'data-rotate'))
        ) {
  ...
  if (
    ...
    (ve._api.setFetch = function (e) {
      M.setFetch(e),
        pe !== M.getAPIModule && ((pe = M.getAPIModule), I.setAPIModule('', pe(j.getAPIConfig)));
    }),
